class Workers {
    ...
    public Workers(String name, String presentAddress, String pastAddress, String NID, String passport, String joiningDate, String educationStatus, double salary) {
        this.name = name;
